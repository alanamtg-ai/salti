...
import { LayoutDashboard, Users2, BarChart3, Users, Inbox, Layers } from "lucide-react";
      ...
      <aside className="hidden lg:flex w-60 flex-col border-r border-border bg-card fixed inset-y-0 left-0 z-30">
        <div className="p-5 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-sm text-foreground tracking-tight">DemandFlow</h1>
